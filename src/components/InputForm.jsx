...
import { FaMapMarkerAlt, FaTruck, FaGasPump, FaBox, FaRoute, FaRedo } from 'react-icons/fa'

function InputForm({ formData, onInputChange, onSubmit, onReset, isCalculating = false }) {
  const vehicleTypes = [
